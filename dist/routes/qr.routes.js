...
const qr_schema_1 = require("../schemas/qr.schema");
const auth_middleware_1 = require("../middlewares/auth.middleware");
const router = (0, express_1.Router)();
router.post('/generate', qrController.generate);
router.post('/approve', auth_middleware_1.authenticate, (0, validate_middleware_1.validate)({ body: qr_schema_1.QrApproveRequestSchema }), qrController.approve);
